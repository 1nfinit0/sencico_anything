/*
Creación de tablas de manera dinámica
Autor: Luis Huatay
Mayo 2022
*/

/*
    Sintáxis de creación de tablas de manera dinámica, se trata de crear una tabla usando select into statments
    La base de datos: tobi, esquema: pruebas
    No tiene mucho caso usarlos, ya que no se puede poner automáticamente el primary key, no puede colcarse
    como seríal y mucho menos, pero aquí está igual v:
*/
...
-- Creación de tablas dinámicas para puntos:
DROP TABLE IF EXISTS prueba.punto_dinamico;
SELECT
    gid::integer as gid,
    nombre::varchar(50) as nombre,
    geom::Geometry(Point,4326) as geom
INTO prueba.punto_dinamico FROM (VALUES
(1,'Punto', ST_SetSRID(ST_MakePoint(-77.15104755984243923,-12.06241976104948854),4326)),
(2,'Punto', ST_SetSRID(ST_MakePoint(-77.15043303693384757,-12.06219860968047541),4326)),
(3,'Punto', ST_SetSRID(ST_MakePoint(-77.15013192070863113,-12.06240654004886004),4326)),
(4,'Punto', ST_SetSRID(ST_MakePoint(-77.14905896371021754,-12.06172385476676645),4326)),
(5,'Punto', ST_SetSRID(ST_MakePoint(-77.14911427077201722,-12.0613740980773958),4326)),
(6,'Punto', ST_SetSRID(ST_MakePoint(-77.14866566904872514,-12.06091015894702068),4326)),
(7,'Punto', ST_SetSRID(ST_MakePoint(-77.14837438519003854,-12.06128876218360624),4326)),
(8,'Punto', ST_SetSRID(ST_MakePoint(-77.14846164744307089,-12.06154236595740592),4326)),
(9,'Punto', ST_SetSRID(ST_MakePoint(-77.14812365984332132,-12.06181399816946076),4326)),
(10,'Punto', ST_SetSRID(ST_MakePoint(-77.14805852041502021,-12.0618644784617377),4326)),
(11,'Punto', ST_SetSRID(ST_MakePoint(-77.14771684567783439,-12.06213130270587186),4326)),
(12,'Punto', ST_SetSRID(ST_MakePoint(-77.14748086888094747,-12.06200750590490145),4326)),
(13,'Punto', ST_SetSRID(ST_MakePoint(-77.14702120574530397,-12.06226591663818226),4326)),
(14,'Punto', ST_SetSRID(ST_MakePoint(-77.14735919334503933,-12.06265293131709448),4326)),
(15,'Punto', ST_SetSRID(ST_MakePoint(-77.14767137098260719,-12.06261086453122999),4326)),
(16,'Punto', ST_SetSRID(ST_MakePoint(-77.14825148060829463,-12.06355556276067986),4326)),
(17,'Punto', ST_SetSRID(ST_MakePoint(-77.14806589468990694,-12.06380195297294478),4326)),
(18,'Punto', ST_SetSRID(ST_MakePoint(-77.14818634117999352,-12.06424184908154018),4326)),
(19,'Punto', ST_SetSRID(ST_MakePoint(-77.14862142339927686,-12.06415771600184428),4326)),
(20,'Punto', ST_SetSRID(ST_MakePoint(-77.14878242840133282,-12.06389930709196356),4326)),
(21,'Punto', ST_SetSRID(ST_MakePoint(-77.14989348582008688,-12.06403151633278981),4326)),
(22,'Punto', ST_SetSRID(ST_MakePoint(-77.14997460284403985,-12.06431516502946444),4326)),
(23,'Punto', ST_SetSRID(ST_MakePoint(-77.15049817636214868,-12.06449665196184107),4326)),
(24,'Punto', ST_SetSRID(ST_MakePoint(-77.15051538300359368,-12.06394137367566266),4326)),
(25,'Punto', ST_SetSRID(ST_MakePoint(-77.15030767426048897,-12.06377791491342677),4326)),
(26,'Punto', ST_SetSRID(ST_MakePoint(-77.15056331579044979,-12.06287288040428685),4326)),
(27,'Punto', ST_SetSRID(ST_MakePoint(-77.15081527018297436,-12.06283201556020757),4326))) AS t(gid,nombre,geom);

-- Creación de tablas dinámicas para líneas:
DROP TABLE IF EXISTS prueba.linea_dinamico;
SELECT
    gid::integer as gid,
    nombre::varchar(50) as nombre,
    geom::Geometry(LineString,4326) as geom
INTO prueba.linea_dinamico FROM (VALUES
(1,'Avenida Agustín Gamarra', ST_SetSRID(ST_MakeLine(ARRAY[
...
(2, 'Calle Ucayali', ST_SetSRID(ST_MakeLine(ARRAY[
...
(3, 'Calle Daniel Nieto', ST_SetSRID(ST_MakeLine(ARRAY[
...
(4, 'Calle Paz Soldán', ST_SetSRID(ST_MakeLine(ARRAY[
...
(5, 'Avenida Miguel Grau', ST_SetSRID(ST_MakeLine(ARRAY[
...
(6, 'Calle Chanchamayo', ST_SetSRID(ST_MakeLine(ARRAY[
...
(7, 'Calle Titicaca', ST_SetSRID(ST_MakeLine(ARRAY[
...
(8, 'Calle EE.UU', ST_SetSRID(ST_MakeLine(ARRAY[
    ST_MakePoint(-77.1523529291153,-12.062626793269512),
    ST_MakePoint(-77.15156435966492,-12.065774357027117)]),4326)),
(9, 'Calle Fanning', ST_SetSRID(ST_MakeLine(ARRAY[
    ST_MakePoint(-77.15149194002151,-12.063967135354165),
    ST_MakePoint(-77.1506416797638,-12.065564520593067)]),4326)),
(10, 'Calle Pichincha', ST_SetSRID(ST_MakeLine(ARRAY[
    ST_MakePoint(-77.14804798364639,-12.064334351194189),
    ST_MakePoint(-77.1478870511055,-12.064837960671113)]),4326)) ) AS t(gid,nombre,geom);

-- Cración de tabla dinámica para polígonos
DROP TABLE IF EXISTS prueba.poligono_dinamico;
SELECT
    gid::integer as gid,
    nombre::varchar(50) as nombre,
    geom::Geometry(Polygon,4326) as geom
INTO prueba.poligono_dinamico FROM (VALUES
(1,'Fortaleza Real Felipe', ST_SetSRID(ST_MakePolygon(ST_MakeLine(ARRAY[
...
(2,'Fiscalía de la Nación',  ST_SetSRID(ST_MakePolygon(ST_MakeLine(ARRAY[
    ...
    ST_MakePoint(-77.14753702282906,-12.06098545525951)])),4326))) AS t(gid,nombre,geom);