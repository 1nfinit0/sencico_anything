package pe.gob.sencico.gestionmap.tools.impl;
...
public class ProcedimientosRequeridosImpl implements ProcedimientosRequeridos{
    ...
    public void executeScriptPython(String id) {
        ...
        String fetching = pathPython+ "conda activate gis; python3 ~/print.py;" + pathFicheroPython + ficheroPython + "conda deactivate";
        System.out.println(fetching);
        try {
            Process process = Runtime.getRuntime().exec("ls -aF " + fetching, null, new File(pathFicheroPython));
