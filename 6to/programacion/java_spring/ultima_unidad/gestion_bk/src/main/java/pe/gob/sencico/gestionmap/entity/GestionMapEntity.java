package pe.gob.sencico.gestionmap.entity;
...
@Entity
@Table(name = "gestionmap", schema = "gestionmap")
public class GestionMapEntity implements Serializable{
    
    private static final long serialVersionUID = -7125186014791704782L;
