package com.galeriademapas.MARCELO.converter.impl;

import org.springframework.stereotype.Component;

import com.galeriademapas.MARCELO.converter.GestionmapaConverter;
...
public class GestionmapaConverterImpl implements GestionmapaConverter{
	...
	public Gestionmapa aEntity(GestionmapaModel model) {
        ...
        entity.setDniResponsable(model.getDniResponsable());
	...
	public GestionmapaModel aModel(Gestionmapa entity) {
        ...
        model.setDniResponsable(entity.getDniResponsable());
